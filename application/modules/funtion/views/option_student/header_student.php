                ...
                <div class="container-fluid">
                    ...
                    <div class="menu-extras topbar-custom">
                        ...
                        <ul class="list-inline float-right mb-0">
                           ...
                           <?php $user = $this->db->get_where('tbl_student',['email' => $this->session->userdata('email')])->row(); ?>
                            <!-- User-->
                            <li class="list-inline-item dropdown notification-list text-center">
                                ...
                                <div style="color: rgba(255, 255, 255, 0.7);">
                                    <span><?php echo $user->Frist_name." ".$user->last_name; ?></span>
                                </div>
                                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                    <a class="dropdown-item" href="profile_student"><i class="dripicons-user text-muted"></i> Profile</a>
                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu">
                                <a href="index_student"><i class="ti-home"></i>Room All</a>
                            </li>

                            <li class="has-submenu">
                                <a href="student_my_room"><i class="ti-home"></i>My Room</a>
                            </li>
